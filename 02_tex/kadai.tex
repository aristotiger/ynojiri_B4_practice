...
\footnotetext[1]{\url{https://youtu.be/QCiERL2m3Ss?si=VuNwWReNZ5sk00k8}}
\footnotetext[2]{\url{https://tabelog.com/ibaraki/A0802/A080201/8002502/}} 
...
\begin{table}[H]
 ...
 \begin{tabular}{|
  ...
  \hline
   ...
   血液型 & A型 \\
   \hline
   好きな曲 & 終わりなき旅(Mr.Children) \footnotemark[1]\\
   \hline
   好きなゲーム & なし \\
   \hline
   好きなアニメ・ドラマ & 進撃の巨人・Mindhunter(Netflix)・傷だらけの天使・俺達は天使だ \\
   \hline
   サークル・部活 & 写真部(高校・大学) \\
   \hline
   オススメのご飯・ご飯屋 & クラレット(つくば)\footnotemark[2]・餃子専門店 正嗣(宇都宮) \\
   \hline
